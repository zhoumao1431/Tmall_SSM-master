...
<style>
    ...
    .tmall-desc dd a:hover{
        color: #fcc137;
    }
    .tmall-ensure a img:hover{
        transform:scale(1.2);
        -webkit-transform:scale(1.2);
        -o-transform:scale(1.2);
    }

    .mui-global-fragment-load  .footer-tmallinfo  a:hover{
        color: #c50000;
    }
    .tmall-desc dl dd img:hover{
        transform:scale(1.2);
        -webkit-transform:scale(1.2);
        -o-transform:scale(1.2);
    }
    .footer-copyright div  img:hover{
        transform:scale(1.2);
        -webkit-transform:scale(1.2);
        -o-transform:scale(1.2);
    }
